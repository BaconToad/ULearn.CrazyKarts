...
ACrazyKartsLearningHud::ACrazyKartsLearningHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void ACrazyKartsLearningHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		ACrazyKartsLearningPawn* Vehicle = Cast<ACrazyKartsLearningPawn>(GetOwningPawn());
